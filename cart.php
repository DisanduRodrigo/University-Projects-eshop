            ...
            if (isset($_SESSION["u"])) {
                ...
                <div class="col-12 border border-1 border-primary rounded mb-3">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <label class="form-label fs-1 fw-bold">Cart <i
                                    class="bi bi-cart4 fs-1 text-success"></i></label>
                        </div>
                                            ...
                                            <div class="row g-0">
                                                <div class="col-md-12 mt-3 mb-3">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <span
                                                                class="fw-bold text-black fs-5"><?php echo $seller; ?></span>&nbsp;
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="card-body">
                                                        ...
                                                        <input type="number"
                                                            class="mt-3 border border-2 border-secondary fs-4 fw-bold px-3 cardqtytext"
